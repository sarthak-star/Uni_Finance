...
import { addFundingSource, createStripeCustomer } from "./stripe.actions";
...
export const exchangePublicToken = async ({publicToken , user} : exchangePublicTokenProps) => {
  try {
    ...
    // Create a processor token for Stripe using the access token and account ID
    ...
    // Add funding source to Stripe customer
